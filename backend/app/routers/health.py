...
def system_readiness():
    ...
    return {
        ...
        "legacy_execution_readiness": "AVAILABLE_WITH_BLOCKERS" if engine_summary["legacy_active_but_beta_blocked"] else "AVAILABLE",
        "registry_governance_readiness": engine_integrity["status"],
        "beta_approval_readiness": "BLOCKED" if engine_summary["licence_blocked"] or engine_summary["runtime_compatibility_unverified"] else "READY",
        "runtime_compatibility_readiness": "BLOCKED" if engine_summary["runtime_compatibility_unverified"] else "READY",
        "beta_licence_blocked_count": engine_summary["licence_blocked"],
        "runtime_version_mismatch_count": engine_summary["runtime_version_mismatch"],
        "runtime_compatibility_unverified_count": engine_summary["runtime_compatibility_unverified"],
        "beta_approved_engine_count": engine_summary["beta_approved_engines"],
        "legacy_active_but_beta_blocked_count": engine_summary["legacy_active_but_beta_blocked"],
        "registry_readiness_warning": "Beta execution is blocked while licence or runtime compatibility remains unresolved." if engine_summary["licence_blocked"] or engine_summary["runtime_compatibility_unverified"] else None,
