# BETA-P1B scientific-engine registry UI

Open **Advanced Tools → Scientific Engines**. The page provides readiness cards, search, class and blocked-state filters, bounded pagination, a responsive engine table, and an engine detail view covering overview, governance, scientific evidence, technical information, provenance, history, and reconciliation.
