...
assert.ok(appSource.includes("Externally checked ADMET endpoints"));
assert.ok(appSource.includes("external_evidence_decision"));
assert.ok(appSource.includes("external_sample_count"));
